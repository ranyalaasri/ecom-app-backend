...
module.exports.CUSTOMER_ACCOUNT_VALIDATED =
  "Customer account validated successfully";
module.exports.INVALID_EMAIL_ALREADY_VALIDATED =
  "Invalid action, this email is already validated";
...
module.exports.CUSTOMER_NOT_VALID =
...
module.exports.CATEGORY_HAS_SUBCATEGORIES =
...
module.exports.SUBCATEGORY_HAS_PRODUCTS =
  "Sproducts attached, cannot delete this subcategory";
...
module.exports.PRODUCT_DUPLICATE_KEY = (field) =>
  `The ${field} you provided is already in use. Please choose a different ${field}`;
...
module.exports.ORDER_STATUS_UPDATED_SUCCESS =
